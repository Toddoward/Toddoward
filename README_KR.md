...
> 🌱 현재 **AI 엔지니어링**을 공부하고 있습니다!
> 👯 **프론트엔드 개발자**, **게임 개발자** 또는 **게임 3D 아티스트**로서 협업을 희망합니다!
...
## 🚀 저를 소개합니다
**저는 창의적인 비주얼 디자인과 기술적 구현 사이의 다리 역할을 하는 프론트엔드 개발자이자 게임 아티스트입니다.**
* 💻 직관적인 UX와 효율적인 알고리즘을 결합하여 **사용자 친화적인 인터페이스**를 구축하는 것을 즐깁니다.
...
### 🌐 웹 개발
* **Video to WebP Converter**: 비디오 파일을 WebP 애니메이션으로 변환해주는 고성능 웹 도구입니다.
<details>
  <summary>🔍 상세 정보 및 미리보기</summary>
  <br>
  <img src="https://via.placeholder.com/600x300" alt="Project Preview" width="600">
  <p>상세 커스터마이징 기능을 갖춘 MP4 to WebP 변환기입니다. 백엔드는 <b>Flask</b>로 구축되었으며, 변환 엔진은 <b>OpenCV</b>를 활용합니다.</p>
  <a href="https://github.com/Toddoward/video_to_webp_converter">
    <img src="https://img.shields.io/badge/저장소_방문하기-181717?style=for-the-badge&logo=github&logoColor=white" alt="Repo">
  </a>
</details>

### 📱 모바일 애플리케이션
* **Serenitree**: 트라우마 치유를 돕는 AI 챗봇 앱 및 LLM 네트워크입니다.
<details>
  <summary>🔍 상세 정보 및 미리보기</summary>
  <br>
  <img src="https://via.placeholder.com/600x300" alt="Project Preview" width="600">
  <p>트라우마 생존자를 위한 동반자 AI 챗봇입니다. 로컬 SQLite DB와 PIN, 생체 인식을 통해 개인정보를 보호합니다. Flutter와 FastAPI를 사용하여 개발되었습니다.</p>
